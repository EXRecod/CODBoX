...
//10.01.2021
 ...
 $lang['from_yesterday']     = 'Вчера'; 
 $lang['from_total']         = 'За все время';
 $lang['ban_forever']        = 'Tban';
 $lang['nothing_search']     = 'Поиск не дал результатов!';
//##################################################################
...
///////////////////////////////////////////////////////////
  ...
  $Elo_rating        = "Рейтинг Эло (навык)"; 
  $LeaderBoardsortingmenu = "Таблица лидеров";
  $bestplmaininfo = "Лучшие игроки отбираются по среднему значению статистики каждой игры по сравнению с другими игроками.";
  $yuuyyuyuyuu    = "Динамика игр.";
  $stats_info_rank = "Позиция";  
  $stats_info_value = "Значение";  
  $index_server = 'Сервера'; 
  $weapon_innf = "Статистика оружия";
  $averarg = "Среднее";
  $lvlvs = "Уровень";
  $profile_sts = "СТАТИСТИКА ПРОФИЛЯ";
  $bestfdxgcyjuhk = "";
  $bestfdxgcyjuhkijlo = "лучший игрок среди всех игроков нашего игрового проекта.";
 ///////////////////////////////////
