...
else if( $prestige < 50 && $prestige >= 40 ){
$image = "/inc/images/prestige/Rank_Prestige_5_CoD4.png";	
return $image;
}
*/
...
/*
else if( $prestige < 200 && $prestige >= 80 ){
...
global $t_player_place_skill,$prestige_0,$prestige_1,$prestige_2,
...
$image = $prestige_1." / ".$prestige." ";
return $image;
*/
} else {

$image = $prestige_0." / ".$prestige." ";
return $image;
 }} 

 function prestige_info_simple($prestige) 
 {
