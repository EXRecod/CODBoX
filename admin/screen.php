...
<html lang="en" class="no-js">
	<head>
		...
		<title><?php echo 'SCREENSHOT ',$plyr,' 💭 ' ?></title>
 <!-- JQUERY FROM GOOGLE API -->
    <script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.4.2/jquery.min.js"></script>
		...
		<![endif]-->		
<script>
var newTxt="<?php echo 'SCREENSHOT 💭 '.$plyr.' '; ?>";
...
body{
  transition:0;
  background-color:#002600; /* #002600 */
  color:#2eb4e9;
  margin: 0;
}
...
if(empty($keey))
die ('</br></br></br></br></br></br></br><center><span>'.$makescreenserrr.'</span></center>');
else
{	
sleep(2);
if(!empty($plyrid))
echo '</br></br></br></br></br></br><center><p>'.$makescreen.'</p></center>';
else
...
<center>
 ...
 <input type="submit" value="<?php echo $makescreens.' '.$plyr; ?>">
  </form>
</center>
