...
<html lang="en" class="no-js">
	<head>
		...
		<title><?php echo 'KICK ',$plyr,' 💭 ' ?></title>
...
if (empty($_GET['all']))	
    echo rcon('clientkick '.$_GET['playernumber'].' '.$rco, '', $connect, $server_rconpass);	
else
	echo rcon('clientkick '.$_GET['playernumber'].' '.$rco, '', $connect, $server_rconpass);
...
<center>
<?php echo 'KICK '.$menu_kick_reason; ?>
   <form> 
 ...
 <input name="playernumber" type="hidden" value="<?php echo $_GET['playernumber']; ?>"> 
